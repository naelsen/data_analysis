...
DF.tmp = DF[,c(2:5)]
# On l'applique à tous les individus
...
On ne garde que les profils qui compte plus de 30 personnes d'avoir des résultats intéréssant a analyser.
...
```{r, echo=FALSE}
# On donne les noms des profils selon chaque variable qualiltative
profils = paste(profils[,1], profils[,2], profils[,3], profils[,4], sep="/")
# On recupère seulement les colonnes des notes attribués pour notre clusteing
DF.notes = DF[,7:20]
...
On commence par faire un clustering hierarchique pour déterminer le nombre de groupes ($K$) idéal.

$K=6$ semble être convenable.
